...
def handle_json_data(json_data):
    if isinstance(json_data, dict):
        return {k: handle_json_data(v) for k, v in json_data.items()}
...
def process_data(file_paths, columns_file, output_path, update_frequency=1000):
    ...
    for json_data in data_stream(file_paths):
        ...
        for date_field in ['application_deadline', 'publication_date', 'last_publication_date']:
            if date_field in cleaned_data:
                cleaned_data[date_field] = clean_date(cleaned_data[date_field])
...
file_paths = ['/Users/svenhammarberg/Desktop/2023 enkel/2023.jsonl']
columns_file = '/Users/svenhammarberg/Desktop/2023 enkel/columns_to_keep_v2.txt'
output_path = '/Users/svenhammarberg/Desktop/2023 enkel/filtrerad_byggbranschen_v2.csv'
